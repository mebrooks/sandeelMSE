---
title: "Area 1r without estimation error"
...
fig_caption: true 
---
This version only uses the MLE values of N, E, R, and Q in the operating models of all simulation trials, rather than having variability among the operating models of the simulation trials based on uncertainty in the estimates from the assessment. This is for comparison with what was done in the 2016 benchmark.
...
pfyrmin = 2036
pfyrmax	= 2041
basename=paste0("MSE_varNERQ_Sigma0_", stock.name, "_RTM_small")

output.path = file.path(stock.name, "plots")
input.path = "~/Desktop/DTU_postdoc/Sandeel_MSE/MSE_code/"

load(file.path(input.path, stock.name, "/organized data.Rdata"))
load(paste0("/Users/molliebrooks/Desktop/DTU_postdoc/Sandeel_MSE/", basename, ".Rdata"))
...
<!-- ```{r 2016MP} -->
<!-- load(paste0("/Users/molliebrooks/Desktop/DTU_postdoc/Sandeel_MSE/MSE_varNERQ_2016MP_", stock.name, "_RTM_small.Rdata")) -->
