########################################################################
stock.name="SAN_area_1r_C"; RTM=TRUE
big_output=FALSE
...
if(!big_output) save(dat, grid, sampyr, file=paste0("MSE_varNERQ_Sigma0_", stock.name, "_RTM_small.Rdata"))
if(big_output) save(dat, grid, sampyr, file=paste0("MSE_varNERQ_Sigma0_", stock.name, "_RTM.Rdata"))
