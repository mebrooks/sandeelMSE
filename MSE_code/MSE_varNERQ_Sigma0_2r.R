...
if(!big_output) save(dat, grid, sampyr, file=paste0("MSE_varNERQ_Sigma0_", stock.name, "_small.Rdata"))
if(big_output) save(dat, grid, sampyr, file=paste0("MSE_varNERQ_Sigma0_", stock.name, ".Rdata"))
