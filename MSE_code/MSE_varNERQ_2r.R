...
########################################################################
#size of MSE
nyears=30 #years to simulate forward
ntrials=1000
Fcap=seq(0, 0.5, by=0.1)
TACmax= 1500000
TACmin= 0
...
if(!big_output) save(dat, grid, sampyr, file=paste0("MSE_varNERQ_", stock.name, "_small.Rdata"))
if(big_output) save(dat, grid, sampyr, file=paste0("MSE_varNERQ_", stock.name, ".Rdata"))
